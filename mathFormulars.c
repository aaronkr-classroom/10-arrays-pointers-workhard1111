...
#include <stdio.h>
#include <stdlib.h> // atoi() 함수 있다. -> arrauTolnt() 작성
#include <ctype.h> // isdigit() 함수 있다. -> numCheck() 작성

int numCheck(char ch)
{
	return ch >= '0' && ch <= '9'; // 1이나 0 반환
}
...
{
	char input[100],
		numStr1[50], numStr2[50], operator = '\0'; //연산자가 NULL로 초기화하기
	int i = 0, //원래 입력한 문자열의 인덱스
		j = 0; //받는 숫자의 인덱스 

	//사용자한테 수학점수 받기 (예: "12+34")
